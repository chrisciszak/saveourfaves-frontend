This is the frontend to saveourfaves.org; it pairs with [the backend code, also open source](https://github.com/chrisciszak/saveourfaves-server), so please read the README there as well.
